...
-- CreateTable
CREATE TABLE "RecommendationsProduct" (
    "id" SERIAL NOT NULL,
    "recommendationId" INTEGER NOT NULL,
    "productId" INTEGER NOT NULL,

    CONSTRAINT "RecommendationsProduct_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "RecommendationsProduct" ADD CONSTRAINT "RecommendationsProduct_recommendationId_fkey" FOREIGN KEY ("recommendationId") REFERENCES "Recommendation"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "RecommendationsProduct" ADD CONSTRAINT "RecommendationsProduct_productId_fkey" FOREIGN KEY ("productId") REFERENCES "Product"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
